...
export default function App() {
  ...
  // Fallback timeout to ensure loading never freezes or produces a white screen
  useEffect(() => {
    const timer = setTimeout(() => {
      setLoading(false);
    }, 2000);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#07090d] flex flex-col items-center justify-center text-slate-100">
        <motion.div 
